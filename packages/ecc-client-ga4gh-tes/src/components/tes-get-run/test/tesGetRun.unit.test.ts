...
describe('TESGetRun', () => {
  it('should have a default baseURL of an empty string', async () => {
    const ele = await fixture<TESGetRun>(
      html`<ecc-tes-get-run></ecc-tes-get-run>`,
    );
  ...
  it('should set the task id correctly', async () => {
    const ele = await fixture<TESGetRun>(
      html`<ecc-tes-get-run id="1234"></ecc-tes-get-run>`,
    );
  ...
  it('should set the task state correctly', async () => {
    const ele = await fixture<TESGetRun>(
      html`<ecc-tes-get-run id="DELETE"></ecc-tes-get-run>`,
    );
