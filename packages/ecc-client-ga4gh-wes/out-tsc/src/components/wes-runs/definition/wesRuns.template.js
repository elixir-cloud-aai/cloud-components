  ...
  <div class="container">
    ...
    <div class="list">
      <fast-accordion>
        ...
        ${when((x) => x.isLoading || x.baseURL.length === 0, html ` ${repeat((x) => Array.from(Array(parseInt(x.pageSize, 10))), html `
              <fast-accordion-item>
                <fast-skeleton
    ...
    <div class="pagination">
      ${when((x) => x.isLoading, html ` ${repeat(() => Array.from(Array(3)), html `
...
//# sourceMappingURL=wesRuns.template.js.map