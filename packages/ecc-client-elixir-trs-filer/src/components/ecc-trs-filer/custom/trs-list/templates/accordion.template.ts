            ...
            >
              <div class="modalVersion">
                ...
                <div class="modalVersion__body">
                  ...
                  <fast-select>
                    <fast-option value="1">1</fast-option>
                  </fast-select>
                  ...
                  <fast-checkbox checked required>is_production</fast-checkbox>

                  <label for="signed">Is signed</label>
                  <fast-checkbox checked required>signed</fast-checkbox>

                  <label for="verified">Is verified</label>
                  <fast-checkbox checked required>verified</fast-checkbox>

                  <fast-text-field name="verified_source" placeholder="verified_source">
