...
<Tabs items={['React', 'HTML/Lit']}>
  <Tabs.Tab>
    ```ts copy
    import ECCClientGa4ghTesRuns from '@elixir-cloud/lit-tes/dist/react/runs/index';
    ```
...
<Callout emoji='🐸' type='info'>
  Read more about this kind of configuration on [details component](/design/components/details#fields).
</Callout>
