...
|          codeOptions          | `false`  | `null`  | `{indentation, language, blurDelay}`                                                                                                | Used to configure code editor fields, please look for docs [here](./code#properties).                                                                                                                                     |
|     fieldOptions.required     | `false`  | `false` | `boolean`                                                                                                                           | Whether the field is required or not.                                                                                                                                                                                     |
|     fieldOptions.disabled     | `false`  | `false` | `boolean`                                                                                                                           | Only configured for type=='code', disables the field.                                                                                                                                                                     |
